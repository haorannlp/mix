...
class MRTSequenceGenerator(object):
    def __init__(
            self,
            tgt_dict,
            beam_size=1,
    ...
    def _generate(
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            # if lprobs.size(0) != target.size(0)*beam_size:
...
class MRTEnsembleModel(torch.nn.Module):
...
class MRTSequenceGeneratorWithAlignment(MRTSequenceGenerator):
    ...
    def generate(self, models, sample, **kwargs):
        model = MRTEnsembleModelWithAlignment(models)
...
class MRTEnsembleModelWithAlignment(MRTEnsembleModel):
    """A wrapper around an ensemble of models."""
